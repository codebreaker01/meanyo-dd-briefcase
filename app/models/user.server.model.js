...
var UserSchema = new Schema({
	...
	/* DD-Brifcase specific properties */
  ...
  aboutMe : {
    type : String,
    require:true,
    validate: [validateLocalStrategyProperty, 'Please say something about yourself']
  },
	joiningDate : {
    type : Date
  },
...
/**
* Transform toJSON method to replace _id with id and remove __v.
*/
